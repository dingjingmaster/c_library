...
> Created Time: 2021年11月07日 星期日 13时53分00秒
 ************************************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <X11/Xlib.h>
 ...
 * output:   none.
 */
void handle_expose(Display* display, GC gc, GC rev_gc, XExposeEvent* expose_event, unsigned int win_width, unsigned int win_height, short pixels[1000][1000])
{
...

    {
        ...
        XDrawLines(display, expose_event->window, gc, points, npoints, CoordModeOrigin);
    }
 ...
 * output:   none.
 */
void handle_button_down(Display* display, GC gc, GC rev_gc, XButtonEvent* button_event, unsigned int win_width, unsigned int win_height, short pixels[1000][1000])
{
    int x, y;
...
void main(int argc, char* argv[])
{
    ...
    XSelectInput(display, win, ExposureMask | KeyPressMask | ButtonPressMask | Button1MotionMask | Button2MotionMask | StructureNotifyMask);
