/*************************************************************************
> FileName: gio-appinfo-1.c
> Author  : DingJing
> Mail    : dingjing@live.cn
> Created Time: 2021年01月18日 星期一 14时57分52秒
 ************************************************************************/
...
static void test_launch_for_app_info (GAppInfo *appinfo)
{
    GError *error = NULL;
    gboolean success;
    GFile *file;
...
static void test_launch_no_app_id (void)
{
    ...
    for (i = 0; i < G_N_ELEMENTS (exec_line_variants); i++) {
        ...
        desktop_file_contents = g_strdup_printf ("%s\n%s", desktop_file_base_contents, exec_line_variants[i]);
...
static void launched (GAppLaunchContext *context,
          GAppInfo          *info,
