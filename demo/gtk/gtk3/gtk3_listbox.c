/*************************************************************************
> FileName: gtk3/gtk3_listbox.c
> Author  : DingJing
> Mail    : dingjing@live.cn
> Created Time: 2021年09月08日 星期三 15时28分01秒
 ************************************************************************/
...
gtk_message_row_update (GtkMessageRow *row)
{
  ...
  if (strcmp (priv->message->sender_nick, "@GTKtoolkit") == 0)
    {
      gtk_image_set_from_icon_name (priv->avatar_image, "org.gtk.Demo4", GTK_ICON_SIZE_LARGE_TOOLBAR);
